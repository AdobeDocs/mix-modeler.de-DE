...
source-git-commit: 9e90a3f7db926e82aa4dc71f0afed9689e51fd3d
workflow-type: tm+mt
...
Experience Platform Data Governance bietet Ihnen die Möglichkeit, Ihre Daten auf dem gesamten Journey zu kontrollieren und zu erfassen, den Daten beim Experience Platform durchlaufen. Diese Journey umfasst die Aufrechterhaltung der Datenqualität, der Datenherkunft, der Datenkatalogisierung und vieles mehr.

Datennutzungsbeschriftungen und -richtlinien, die für Datensätze erstellt werden, die von der Experience Platform-Oberfläche im Mix Modeler verwendet werden, sofern zutreffend. Beispielsweise stoppen oder warnen diese Kennzeichnungen Benutzende, wenn sie Datensätze löschen, die Teil einer Datensatzregel in den harmonisierten Daten sind. Oder blenden Sie Schemafelder aus, die beim Erstellen einer Datensatzregel für Benutzer eingeschränkt sind.
...
| Audit-Protokolle | Mix Modeler Wenn Benutzende bestimmte Benutzerkategorien erstellen, aktualisieren oder löschen, zeichnet die Funktion &quot;Experience Platform Audit“ die Aktivität in den Auditprotokollen auf. Weitere [ finden Sie ](audit-logs.md) Auditprotokolle . |
| Richtlinien | Im Rahmen des harmonisierten Daten-Workflows werden vom Experience Platform definierte Richtlinien durchgesetzt. Jeder Verstoß gegen Datennutzungskennzeichnungen wird gemeldet und dem Benutzer angezeigt. Weitere Informationen finden [ unter ](policies.md). |
