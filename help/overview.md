...
<table style="table-layout:fixed">
  <tr style="border: 0;">
    ...
    <div><strong>Schnellstart</strong><br/> Verschaffen Sie sich einen Überblick über und insight in den Workflow von Mix Modeler.</div>
    </td>
    <td>
