...
Wenn ein Modell, das Sie für Ihren Plan verwendet haben, mit neuen Daten bewertet wird, müssen Sie einen neuen Plan erstellen, um die wiederhergestellten Daten zu berücksichtigen.
...
1. Sie sehen eine Tabelle der aktuellen Pläne und ihres Status.
   ...
   | Spaltenname | Details |
   |---|---|
   | **[!UICONTROL Name]** | Name des Plans |
   | **[!UICONTROL Model]** | Das als Grundlage für den Plan verwendete Modell. |
